...
<div class="dark:bg-gray-800 text-gray-900 m-auto w-9/12 bg-white dark:text-gray-100">
    ...
    <p class="text-gray-700 dark:text-gray-300" id="time">php-library {{ \Composer\InstalledVersions::getPrettyVersion('sonypradana/php-library') }} (PHP v{{ phpversion() }})</p>
    ...
    <div class="grid grid-flow-row grid-cols-2 gap-4 py-2">
        ...
        <div class="p-2 min-h-24 rounded-md shadow-lg border-gray-700 bg-gray-200 dark:bg-gray-700">
            <div class="text-lg font-semibold text-gray-900 dark:text-gray-100">Template Engine</div>
